			...
			<div>
				<section className={css.sections}>
					<ul className={css.thanks}>
						...
						<li>
							<a href="" target="_blank">Jihad Hassan - Marketing Director <Icon icon={[ 'fad', 'arrow-up-right-from-square' ]} /></a>
							<p>Thank you for all the advice and feedback.</p>
						</li>
						<li>	
							<a href="https://www.youworkforthem.com/designer/536/colorpong?aff=1115" target="_blank">Colorpong - Artist <Icon icon={[ 'fad', 'arrow-up-right-from-square' ]} /></a>
							<p>Checkout their amazing vector illustrations. </p>
						</li>
						<li>
							<a href="https://brittanychiang.com/" target="_blank">Brittany Chiang - Software Engineer <Icon icon={[ 'fad', 'arrow-up-right-from-square' ]} /></a> 
							<p>A major inspiration behind this open source theme.</p>
						</li>
						<li><a href="https://vercel.com/docs" target="_blank">Vercel - Platform <Icon icon={[ 'fad', 'arrow-up-right-from-square' ]} /></a>
					...
					<ul className={css.links}>
						<li><h4>Links</h4></li>
						<li>
							<a href="https://www.youworkforthem.com/?aff=1115" target="_blank">YWFT Creative Marketplace <Icon icon={[ 'fad', 'arrow-up-right-from-square' ]} /></a>
				...
				<section className={css.github}>
					<a href="https://github.com/atlamors/portfolio-theme" target="_blank">
